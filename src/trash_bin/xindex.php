...
// $statusCodes = [404 => ['message' => 'Not found'], 500 => ['message' => 'effffrror']];

// print_r($statusCodes[500]['message']);
    ...
    // $e = 654;
    if (!array_key_exists($e ?? null, $httpStatusCodes)) {
        echo "jest null albo zly kod";
    } else {
        echo $httpStatusCodes[$e];
    };

    // print_r("cos");
    // print_r(in_array('100', $httpStatusCodes));
    // echo in_array('100', $httpStatusCodes);
    // echo $httpStatusCodes['100'];
    if (in_array('100', $httpStatusCodes)) {

    echo "działa";
    }

// $markse = array(100 => "ff", 65 => "ff", 70 => "ff", 87 => "ff");
...
// $marks = array(100 => ['msg' => "dd"], 65 => ['msg' => "dd"], 70 => ['msg' => "dd"], 87 => ['msg' => "dd"]);
// if (in_array("100", $marks)) {
//     echo "found";
// } else {
//     echo "not found";
...
$marks = array(100 => ['msg' => "dd"], 65 => ['msg' => "dd"], 70 => ['msg' => "dd"], 87 => ['msg' => "dd"]);
if (array_search("100", $marks)) {
    echo "found";
} else {
    echo "not found";
    print_r($marks['100']['msg']);
...
// $e = 511;
// if (in_array(strval($e), $httpStatusCodes)) {
//     echo "Działa!";
// } else {
//     echo "nie działa";
// }
